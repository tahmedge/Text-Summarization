...
class BeamSearchDecoder(object):
  ...
  def decode(self,decoded_file,ref_file):
    ...
    while True:
      ...
      #original_article = str(original_article, 'utf-8')
      #original_abstract = str(original_abstract, 'utf-8')
      #original_abstract_sents= str( original_abstract_sents, 'utf-8')
      original_abstract=original_abstract.decode("utf-8")
      original_abstract_sents = original_abstract_sents.decode("utf-8")
      original_article =  original_article.decode("utf-8")
      ...
      try:
        ...
        decoded_words = decoded_words[:fst_stop_idx-1]
      except ValueError:
        decoded_words = decoded_words[:-1]
      decoded_output = ' '.join(decoded_words) # single string

      if FLAGS.single_pass:
        self.write_for_rouge(original_abstract_sents, decoded_words, counter,decoded_file,ref_file) # write ref summary and decoded summary to file, to eval with pyrouge later
  ...
  def write_for_rouge(self, reference_sents, decoded_words, ex_index,decoded_file,ref_file):
    ...
    ref_sents=''.join(ref_sents)
    decoded_file.write(str(decoded_sents)+"\n")
    ref_file.write(str(ref_sents)+"\n")
  ...
  def write_for_attnvis(self, article, abstract, decoded_words, attn_dists, p_gens):
    ...
    output_fname = 'attn_vis_data.json'
