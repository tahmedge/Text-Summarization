...
def attention_decoder(decoder_inputs, initial_state, encoder_states, rel_scores, cell, initial_state_attention=False, pointer_gen=True, use_coverage=False, prev_coverage=None):
  """
  Args:
